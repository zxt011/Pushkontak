...
switch (command) {
case "menu": case "p": case "assalamualaikum": case "revan": {
let teksnya = `*𝙃𝙖𝙞* @${m.sender.split("@")[0]}!

𝗔𝗞𝗨 𝗔𝗗𝗔𝗟𝗔𝗛 𝗕𝗢𝗧 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗣𝗨𝗦𝗛 𝗞𝗢𝗡𝗧𝗔𝗞 𝗕𝗨𝗔𝗧𝗔𝗡 𝗥𝗘𝗩𝗔𝗡 𝗖𝗥𝗔𝗦𝗛🦅
...
{  "header": "Script RevanCrash V6.7", "title": "List Harga RevanCrash V6.7", "description": "© ${namabot2}", "id": ".list_scbot" }]}, { "title": "# Tools Owner Bot", "rows": [{ "header": "Auto Read", "title": "Pilih Opsi ON/OFF", "description": "© ${namabot2}", "id": ".autoread" }, 
{ "header": "Auto Read Story", "title": "Pilih Opsi ON/OFF", "description": "© ${namabot2}", "id": ".autoreadsw" }, 
{ "header": "Main Menu", "title": "List Main Menu Command", "description": "© ${namabot2}", "id": ".mainmenu" }, 
{ "header": "THIS IS RevanCrash", "title": "THIS IS DAPP", "description": "© ${namabot2}", "id": ".play avangard" }, 
{ "header": "Anti Call", "title": "Pilih Opsi ON/OFF", "description": "© ${namabot2}", "id": ".anticall" }]}]}`
},
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"RevanCrash\",\"id\":\".play avangard\"}`
}]
}), 
contextInfo: {
isForwarded: true,
...
{
"name": "cta_url",
"buttonParamsJson": `{\"display_text\":\"THIS IIS REVAN ⚡\",\"id\":\".play avangard\"}`
}]
}),
})}
}}, {userJid: m.sender, quoted: qtoko})
